    ...
    <jet-action-section>
        ...
        <template #content>
            ...
            <div class="flex items-center mt-5">
                <jet-button class="btn-outline-primary" @click="confirmLogout">
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal" :idModal="IdModalLogoutOther">
                <template #title>
                    {{ __('Log Out Other Browser Sessions') }}
                </template>
                ...
                <template #footer>
                    ...
                    <jet-button class="btn-primary" @click="logoutOtherBrowserSessions" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                        {{ __('Log Out Other Browser Sessions') }}
                    </jet-button>
                </template>
            </jet-dialog-modal>
    ...
    export default {
        ...
        data() {
            return {
                ...
                IdModalLogoutOther: 'modal-logout-other',
            }
        },
        ...
        methods: {
            confirmLogout() {
                ...
                $('#'+this.IdModalLogoutOther).modal('show');
            ...
            closeModal() {
                ...
                this.form.reset()
                $('#'+this.IdModalLogoutOther).modal('hide');
            },
        },
    }
</script>
