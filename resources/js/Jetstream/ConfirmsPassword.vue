        ...
        <jet-dialog-modal :show="confirmingPassword" @close="closeModal" :idModal="idModal">
            ...
            <template #content>
                ...
                <div class="form-group">
                    <jet-label>{{ __(content) }}</jet-label>
                    <jet-input type="password" :placeholder="__('Password')"
            ...
            <template #footer>
                ...
                <jet-button class="btn-primary" @click="confirmPassword" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                    {{ __(button) }}
                </jet-button>
            </template>
        </jet-dialog-modal>
